...
<head>
  <meta charset="UTF-8">
  <title>Ejemplos de Cookies en PHP</title>
...
<body>
  <div class="container">
    <h1>Ejemplos de Cookies en PHP</h1>
    ...
    <div class="viewer-box">
      <!-- iframe corregido -->
      <iframe id="visor" src="ejemplo1.php"
  ...
  <script>
    function cargar(tipo) {
      ...
      if (tipo === 'codigo') {
        visor.src = `../assets/mostrarCodigo.php?archivo=${archivo}&tipo=cookies`;
      } else {
        visor.src = archivo;
      }
    }
