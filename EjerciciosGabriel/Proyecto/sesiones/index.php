...
<body>
  <div class="container">
    ...
    <div class="viewer-box">
      <iframe id="visor" src="../assets/mostrarCodigo.php?archivo=ejemplo1.php&tipo=sesiones"></iframe>
    </div>
  ...
  <script>
    function cargar(tipo) {
      ...
      if (tipo === 'codigo') {
        visor.src = `../assets/mostrarCodigo.php?archivo=${archivo}&tipo=sesiones`;
      } else {
        visor.src = archivo;
      }
    }
